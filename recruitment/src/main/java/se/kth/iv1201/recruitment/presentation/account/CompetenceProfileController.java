...
public class CompetenceProfileController {
    ...
    /**
     * Constructs the CompetenceProfileController with the required
     * ApplicationService dependency. The ApplicationService
     * is used to handle the business logic of submitting the competence profile
     * application.
     * 
    ...
    /**
     * Initializes the competence profile form with default values. This method is
     * called before any request handling method in this
     * controller, and ensures that there is a competence profile form object in the
     * session for the user to fill out. The form is
     * initialized with one empty date range and one empty experience to allow the
     * user to start filling out their competence profile
     * immediately.
     * 
    ...
    public CompetenceProfileForm initializeForm() {
        ...
        form.getDateRanges().add(new DateRangeForm());
     ...
     *         competences should appear.
     * @return If button for "+" next to dates are pressed, a new row of dates
     *         should appear.
     * @return Returning to the review page, if all required parts are filled out,
     *         and review button is pressed.
    ...
    /**
     * Cancels the competence profile form submission process by clearing the
     * session attributes and returning
     * to the competence profile page.
     * 
     * @param sessionStatus used to clear the session attributes related to the
     *                      competence profile form
    ...
    /**
     * Handles the review of the competence profile form. This method is called when
     * the user clicks the "Review"
     * button on the competence profile form.
     * 
     * @return the view name for the competence profile review page, where the user
     *         can see a summary of their input and
     *         confirm submission.
     */
    ...
    /**
     * Handles the final submission of the competence profile form. It calls the
     * application service to submit the application,
     ...
     * @return: Returns to competence_success view if the submission is successful,
     *          otherwise review view.
     */
